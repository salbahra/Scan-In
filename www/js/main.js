...
if ( isWinApp ) {
	...
	if ( Windows.UI.ApplicationSettings.SettingsPane ) {
            ...
            function( result ) {
                ...
                var signIn = function() {
                        ...
                        $.post( "https://docs.google.com/forms/d/e/" + dataMap[ form ].id + "/formResponse", data, function( reply ) {
                            ...
                            // Show success
                            showError( _( "Sign in was successful!" ), 8000 );
                        } ).fail( function() {

                                // Show failure
                                showError( _( "Unable to finish sign in due to a connection problem. Please try again." ) );
                            }
                        );
                    },
